...
echo "Running sbatch python_launch.sh"
...
# LAUNCH FROM SLURM
echo "Starting launch from plain python launch..."
...
python $BASE_DIR/train_gpt.py --config $BASE_DIR/gpt2_configs/gpt2_pp1d_8gpu.py --host $(hostname -i | head -1) --rank 8 --world_size 2
